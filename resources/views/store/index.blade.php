...
<section class="discount-section overflow-hidden pb-100">
    <div class="container">
        <div class="row gy-lg-0 gy-4">
            ...
            <div class="col-lg-6">
                <div class="discount-item food-discount food-discount-2" style="--rr-color-theme-primary: #67B02E">
                    <div class="content">
                        <span>Weekend Discount</span>
        ...
        <div class="row product-item-wrap gy-xl-0 gy-4 justify-content-center">
            ...
            <div class="col-xl-2 col-lg-3 col-md-6">
                <div class="product-item">
                    ...
                    <div class="product-content">
                        <span class="category">Nescafe USA</span>
                        <h3 class="title"><a href="shop-details.html">Greek Gods Probiotic Plain Traditional</a></h3>
                        <h4 class="quantity">9 oz Pack</h4>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="item-wrap">
                    <div class="discount-item food-discount">
                        ...
                        <div class="men"><img src="assets/img/images/food-discount-3.png" alt="img"></div>
                    </div>
                    <div class="discount-item food-discount" style="--rr-color-theme-primary: #67B02E">
                        <div class="content">
                            <span>-45 % Offer</span>
                        ...
                        <div class="men"><img src="assets/img/images/food-discount-4.png" alt="img"></div>
                    </div>
                </div>
            </div>
            <div class="col-xl-2 col-lg-3 col-md-6">
...
<div class="discount-cta mb-60">
    <div class="container p-0">
        <div class="discount-cta-wrap text-center pt-35 pb-35" data-background="assets/img/bg-img/discount-cta-bg.jpg">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="true">New Sale
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                                        type="button" role="tab" aria-controls="profile" aria-selected="false">On Sale
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact"
                                        type="button" role="tab" aria-controls="contact" aria-selected="false">Best
                                    Rated
                                </button>
                            </li>
                        </ul>
                                    ...
                                    <div class="col-xl-3 col-md-6 single-item veg tea">
                                        <div class="product-item product-item-2">
                                            ...
                                            <ul class="product-list">
                                                <li><a href="#"><i class="fa-sharp fa-regular fa-plus"></i></a></li>
                                                <li><a href="#"><i class="fa-regular fa-heart"></i></a></li>
                                                <li><a href="#"><i class="fa-solid fa-arrow-right-arrow-left"></i></a>
                                                </li>
                                            </ul>
                                            <div class="product-thumb">
                                                <img src="assets/img/product/popular-1.png" alt="img">
                                            ...
                                            <div class="product-content">
                                                <span class="category">Nescafe USA</span>
                                                <h3 class="title"><a href="shop-details.html">Hillshire Farm Thin Sliced
                                                        Honey Deli Lunch Meat</a></h3>
                                                <h4 class="quantity">9 oz Pack</h4>
                                                <span class="price">$257.00 <span class="offer">$450.00</span></span>
                                            </div>
                                            <div class="product-bottom">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-widget">
                    ...
                    <div class="news-form-wrap">
                        <p class="mb-20">Subscribe to the mailing list to receive updates one the new arrivals and other
                            discounts</p>
            ...
            <div class="row copyright-content">
                <div class="col-lg-6">
                    <div class="footer-img-wrap">
                        ...
                        <div class="footer-img"><a href="#"><img src="assets/img/images/footer-img-1.png" alt="img"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
